          ...
          <ul className="works">
              ...
              <ul className="works">
                <a href="https://github.com/sivin-git">
                  <div className="piece inner_container">
                    <div className="image">
                      <LazyLoadImage className="workimg" src={Clock} alt="" effect="blur"/>
                    </div>
                    <div className="piece_content">
              ...
              <ul className="works">
                <a href="https://github.com/sivin-git/ChatNow">
                  <div className="piece inner_container">
                    <div className="image">
                      <LazyLoadImage
                        className="workimg" src={Chatnow} alt="" effect="blur"/>
                    </div>
                    <div className="piece_content">
              ...
              <ul className="works">
                <a href="https://github.com/sivin-git">
                  <div className="piece inner_container">
                    <div className="image">
                      <LazyLoadImage className="workimg" src={FB} alt="" effect="blur"/>
                    </div>
                    <div className="piece_content">
              ...
              <ul className="works">
                <a href="https://github.com/sivin-git/Fish-Bowl">
                  <div className="piece inner_container">
                    <div className="image">
                      <LazyLoadImage className="workimg" src={Fishbowl} alt="" effect="blur"/>
                    </div>
                    <div className="piece_content">
              ...
              <ul className="works">
                <a href="https://github.com/sivin-git">
                  <div className="piece inner_container">
                    <div className="image">
                      <LazyLoadImage
                        className="workimg" src={TicTacToe} alt="" effect="blur"/>
                    </div>
                    <div className="piece_content">
              ...
              <ul className="works">
                <a href="https://github.com/sivin-git/Color-Switcher">
                  <div className="piece inner_container">
                    <div className="image">
                      <LazyLoadImage
                        className="workimg" src={Colorswitcher} alt="" effect="blur"/>
                    </div>
                    <div className="piece_content">
              ...
              <ul className="works">
                <a href="https://github.com/sivin-git">
                  <div className="piece inner_container">
                    <div className="image">
                      <LazyLoadImage className="workimg" src={Todo} alt="" effect="blur"/>
                    </div>
                    <div className="piece_content">
              ...
              <ul className="works">
                <a href="https://github.com/sivin-git/Tip-Calculator">
                  <div className="piece inner_container">
                    <div className="image">
                      <LazyLoadImage className="workimg" src={Tip} alt="" effect="blur"/>
                      <div className="piece_content">
              ...
              <ul className="works">
                <a href="https://github.com/sivin-git/QRCode-Generator">
                  <div className="piece inner_container">
                    <div className="image">
                      <LazyLoadImage className="workimg" src={QRcode} alt="" effect="blur"/>
                    </div>
                    <div className="piece_content">
              ...
              <ul className="works">
                <a href="https://github.com/sivin-git/Emoji-Switcher">
                  <div className="piece inner_container">
                    <div className="image">
                      <LazyLoadImage
                        className="workimg" src={Emoji} alt="" effect="blur"/>
                    </div>
                    <div className="piece_content">
              ...
              <ul className="works">
                <a href="https://github.com/sivin-git">
                  <div className="piece inner_container">
                    <div className="image">
                      <LazyLoadImage className="workimg" src={Sound} alt="" effect="blur"/>
                    </div>
                    <div className="piece_content">
